...
public class OVRGrabber : MonoBehaviour {
    ...
    protected Transform m_lastParent = null;
    protected Quaternion m_grabbedObjInitialRot;
    ...
    void OnUpdatedAnchors() {
        ...
        m_prevFlex = OVRInput.Get(OVRInput.Axis1D.PrimaryHandTrigger | OVRInput.Axis1D.PrimaryIndexTrigger, m_controller);
    ...
    protected virtual void GrabBegin() {
        ...
        if (closestGrabbable != null) {
            ...
            // Stash the initial rotation.
            m_grabbedObjInitialRot = m_grabbedObj.transform.localRotation;
            ...
            if (m_parentHeldObject) {
                if (!m_grabbedObj.GetComponent<OVRGrabber>()) {
                    m_lastParent = m_grabbedObj.transform.parent;
                } else {
                    Debug.Log("Not re-assigning parent to OVRGrabber");
                }
    ...
    protected void GrabbableRelease(Vector3 linearVelocity, Vector3 angularVelocity) {
        if (m_parentHeldObject) {
            m_grabbedObj.transform.SetParent(m_lastParent, true);
            m_grabbedObj.transform.rotation = m_grabbedObjInitialRot;
        }
